...
from patch.utils.median_pool import MedianPool2d
...
class PatchTransformer(nn.Module):
    ...
    def forward(self, adv_patch, lab_batch, model_in_sz, use_mul_add_gau=True, do_transforms=True, do_rotate=True, rand_loc=True):
        ...
        #print(adv_patch.shape) # torch.Size([3, 64, 64])
        ...
        # print('lab_batch', lab_batch.size()) # lab_batch torch.Size([1, 48, 5])
        # print(batch_size) # torch.Size([1, 48])
        # print(adv_patch.shape) # torch.Size([1, 1, 3, 64, 64])
        ...
        # print(lab_batch)
        # print(lab_batch.shape) # torch.Size([1, 48, 5])
        # print(lab_batch[..., 0])
